...
BASE_DIR = os.path.abspath(os.path.dirname(_file))  # Corrected from _file to _file_
DATABASE = os.environ.get("DB_URI", f"sqlite:///{os.path.join(BASE_DIR, 'app.db')}")

# Initialize Flask app
app = Flask(_name)  # Corrected from _name to _name_
...
if _name_ == "_main":  # Corrected from _name to _name_
